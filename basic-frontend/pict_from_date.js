  ...
  render() {
    ...
    if (!this.state.error && this.state.liked && this.state.loaded) {
      ...
      return e('div',
        ...
        g,
        e('button',
      { onClick: () => this.setState({ liked: false, loaded: false }) },
      'Hide Pictures from Date')
      );
    }
    ...
    return e('div', {}, 
      e('div', {}, 
        e('button',
          { onClick: () => { this.setState({ liked: true }); this.fetchFromDate(); }, key: 'pictFromDate' },
          'Show Pictures from Date'
        )
      ),
      e('div', {},
        e('input',
          { placeholder: 'YYMMDD', type: 'date', key: 'input', min: "2011-04-20", onChange: e => this.setState({ date: e.target.value }) },
          null
        )
      )
    );
